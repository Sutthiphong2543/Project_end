...
<head>
    ...
    <link rel="stylesheet" href=" ../css/css_editVillagers.css ?<?php echo time(); ?>">
            ...
            <!-- Content -->
                <div class="box-edit ">
                    ...
                    <div class="box-edit-2 bd-c">
                        <!-- Form -->
                        <form action="updateVillager.php" method="post"class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="form-footer">
                                <button type="submit" name= "update" class="btn btn-primary mt-3">ยืนยันการแก้ไขข้อมูล</button>
                                <a class="btn btn-secondary mt-3" href="../views/ad_villager.php?title=villagers">ย้อนกลับ</a>
                            </div>
