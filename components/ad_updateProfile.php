...
if(isset($_POST["addUpdate"])){
    ...
    $result=$user->updateLegal($fname,$lname,$telephone,$legal_id,$username,$fileNew);
    if($result){
        $_SESSION['success'] = " Data has been inserted successfully.";
                ...
                header('refresh:2;/project_end/views/ad_dashboard.php?title=dashboard');
            }else {
                ...
                // header('refresh:2;/project_end/views/dashboard.php?title=dashboard');
    }
}
